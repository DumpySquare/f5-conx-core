 ...
 */
export declare type AuthTokenReqBody = {
    username: string;
    password: string;
 ...
 */
export declare type AtcRelease = {
    version: string;
    id: number;
    assets: Asset[];
};
export declare type GitRelease = {
    tag_name: string;
    id: number;
    assets: Asset[];
};
...
export declare type AtcVersion = {
    releases?: AtcRelease[];
    latest?: string;
};
export declare type AtcVersions = {
 ...
 */
export declare type F5DownLoad = 'UCS' | 'QKVIEW' | 'ISO';
/**
 * types of F5 uploads
 * - FILE
 ...
 *  - path: '/shared/images'
 */
export declare type F5Upload = 'ISO' | 'FILE' | 'UCS';
/**
 * as3 declaration type model
 */
export declare type As3Dec = {
    $schema?: string;
    class: 'AS3';
    action?: string;
    persist?: boolean;
 ...
 */
export declare type AtcMetaDataSdk = {
    components: {
        fast: FastMetaData;
        do: DoMetaData;
        as3: As3MetaData;
...
export declare type FastMetaData = {
    endpoints: {
        info: {
            uri: string;
            methods: string[];
...
export declare type DoMetaData = {
    endpoints: {
        configure: {
            uri: string;
            methods: string[];
...
export declare type As3MetaData = {
    endpoints: {
        configure: {
            uri: string;
            methods: string[];
...
export declare type TsMetaData = {
    endpoints: {
        configure: {
            uri: string;
            methods: string[];
...
export declare type CfMetaData = {
    endpoints: {
        configure: {
            uri: string;
            methods: string[];
